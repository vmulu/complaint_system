...
from .complaints.responses import DocumentAccountError, NoComplaintFoundError, DocumentUploadError, PIIDetectionError, NoPriorityOverrideReasonError, DeleteConfirmationRequiredError
...
def create_app():
    ...
    @app.errorhandler(DeleteConfirmationRequiredError)
    def handle_no_delete_complaint_confirmation_error(error : DeleteConfirmationRequiredError):
